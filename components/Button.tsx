...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    toolbar: `p-2 rounded hover:bg-slate-100 ${active ? 'bg-blue-100 text-blue-700' : 'text-slate-600'} focus-visible:ring-[#0a66c2]`,
    primary: "px-4 py-2 bg-[#0a66c2] text-white rounded-full hover:bg-[#004182] focus-visible:ring-[#0a66c2]",
    secondary: "px-4 py-2 bg-white border border-slate-300 text-slate-700 rounded-full hover:bg-slate-50 focus-visible:ring-slate-400"
  };
